...
export function ModelClinic(props) {
  ...
  return (
    <group {...props} dispose={null} position={[-1.3, -0.2, 1.5]} rotation={[0, 5, 0]} scale={0.0005}>

        <group position={[0, 876.868, 0]} {...props} dispose={null} rotation={[-Math.PI / 2, 0, 0]} scale={100} onClick={() => alert('Clicou no Cubo 018')}>
          <mesh
            castShadow
            receiveShadow
